...
* [Individual model config](docs/individual_model_config.md)
* [Model static methods](docs/model_static_methods.md)
* [Model instance methods](docs/model_instance_methods.md)
